...
% Initialize values
m = [.02 .02 .02];            % Masses of the three links in kg
l = 25.4*[3 5.75 7.375]; % Lengths of three links in mm
r = 25.4*[1 1 1];        % Radii of three links in mm
g = 9806.65;            % Grav. constant mm/s^2
